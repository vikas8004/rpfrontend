      ...
      <VStack width={"100%"} mt={"65px"} mb={"20px"}>
          ...
          >
            <tbody>
              ...
              <tr>
                ...
                <td>{annually.hindi}</td>
                <td>
                  {spreadSum(quaterly.hindi, halfyearly.hindi, annually.hindi)}
                </td>
              </tr>
              <tr>
                <td>English</td>
              ...
              <tr>
                ...
                <td></td>
                <td>{spreadSum(10, unitTest2.max, unitTest3.max)}</td>
                <td>{spreadSum(unitTest1.gk + unitTest2.gk + unitTest3.gk)}</td>
                <td>{quaterly.gk}</td>
                <td></td>
                <td>{quaterly.max}</td>
                <td>{quaterly.gk}</td>
              ...
              <tr>
                ...
                <td></td>
                <td>{spreadSum(10, unitTest2.max, unitTest3.max)}</td>
                <td>{spreadSum(unitTest1.pt + unitTest2.pt + unitTest3.pt)}</td>
                <td>{quaterly.pt}</td>
                <td></td>
                <td>{quaterly.max}</td>
                <td>{quaterly.pt}</td>
        ...
        <HStack width={"90%"} justifyContent={"space-between"}>
          <VStack>
            ...
            >
                <Text  width={"100%"}fontWeight={"600"} py={"4px"}>Date</Text>
            </HStack>
            <HStack
              width={"100px"}
              height={"30px"}
          ...
          <VStack>
            ...
            >
                <Text textAlign={'center'} width={"100%"}fontWeight={"600"} py={"4px"}>Prepared By</Text>
            </HStack>
            <HStack
              width={"100px"}
              height={"30px"}
           ...
           <VStack>
            ...
            >
                <Text textAlign={'center'} width={"100%"}fontWeight={"600"} py={"4px"}>Chekced By</Text>
            </HStack>
            <HStack
              width={"100px"}
              height={"30px"}
          ...
          <VStack>
            ...
            >
                <Text textAlign={'right'} width={"100%"}fontWeight={"600"} py={"4px"}>Principal</Text>
            </HStack>
            <HStack
              width={"100px"}
              height={"30px"}
